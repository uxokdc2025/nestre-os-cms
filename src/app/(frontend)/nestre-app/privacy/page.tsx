...
// NESTRE app Privacy Policy at the exact URL the mobile app links to
// (/nestre-app/privacy). Same legally-approved text as /privacy, rendered on the
// shared legal-page pattern so it looks and reads identically.
export const dynamic = 'force-dynamic'

export const metadata: Metadata = {
  title: 'Privacy Policy',
  description: 'How NESTRE Health & Performance collects, uses, and protects your personal information.',
  alternates: { canonical: `${SITE_URL}/nestre-app/privacy` },
  openGraph: { title: 'Privacy Policy · NESTRE', url: `${SITE_URL}/nestre-app/privacy`, images: [{ url: '/og', width: 1200, height: 630 }] },
...
export default function NestreAppPrivacyPage() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(webPageGraph('Privacy Policy', '/nestre-app/privacy', 'How NESTRE Health & Performance collects, uses, and protects your personal information.')) }} />
