...
const blocks: Record<string, any> = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Consultation Consent & Disclaimer', a: 'By scheduling a NESTRE Consultation, you acknowledge that this consultation is intended to evaluate cognitive performance, establish a baseline of mind and brain function, and provide personalized training recommendations. You understand that NESTRE’s services are educational and performance-focused and are not intended to diagnose, treat, cure, or prevent any medical, neurological, or mental health condition, nor do they replace the advice or care of a licensed healthcare provider and should not be used to treat or diagnose any medical conditions. Participation in any assessment or training is voluntary, and you are responsible for informing NESTRE of any medical conditions, injuries, implanted medical devices, or other circumstances that may affect your participation prior to your consultation. Recommendations provided during your consultation are based on the information collected during your consultation and are intended solely for your personal use and performance development. By proceeding with your booking, you voluntarily assume responsibility for your participation, release NESTRE and its affiliates from liability to the fullest extent permitted by applicable law for claims arising from your voluntary participation and acknowledge that individual experiences and outcomes will vary and cannot be guaranteed.' },
    ],
  },
