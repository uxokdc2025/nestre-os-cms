...
// design system. All booking runs through Acuity (owner 23912005) via the same
// catalog links, kept at the original URLs so ads + scheduling keep working.
...
// Shared package copy (same across every location; ids differ per location).
    ...
    <main id="main">
      ...
      <section className="sec navy">
        <div className="wrap">
          ...
          <p className="lead" style={{ color: 'rgba(255,255,255,.8)', marginTop: 16, maxWidth: '60ch' }}>
      ...
      <section className="sec paper">
        <div className="wrap">
          ...
          <h2 className="h2" style={{ marginTop: 14 }}>{cfg.videoHeading}</h2>
          <div className="sched-video thumb-lg">
            <video src={cfg.video} controls playsInline preload="metadata" />
          </div>
        </div>
      </section>

      {/* Summer promo */}
      <section className="sec paper" id="nestre-consultation-promotions">
        <div className="wrap">
          <div className="promo-card">
            ...
            <p className="lead muted" style={{ marginTop: 12 }}>Use code <strong>JUMPSTART</strong> at checkout.</p>
      ...
      <section className="sec paper">
        <div className="wrap">
          <p className="eyebrow">Ongoing training</p>
          <h2 className="h2" style={{ marginTop: 14 }}>Training packages.</h2>
          <p className="lead muted" style={{ maxWidth: '56ch', marginTop: 12 }}>
            Targeted programs that build on your consultation. Each is a personalized block of
            Neuro-Strength Training focused on a specific area of performance.
          </p>
          <div className="pkg-grid">
            {cfg.packages.map((p, i) => (
              <div key={p.name} className="pkg-card" style={{ ['--i' as string]: i } as React.CSSProperties}>
                <h3>{p.name}</h3>
